...
System.out.println("Brand: Fire-Bolt");
System.out.println("About this item:");
System.out.println("Large 1.85-inch Touchscreen Display: Immerse yourself in vivid visuals and effortless navigation with a crystal-clear 1.85-inch display");
System.out.println("Bluetooth Calling on the Go: Make and receive calls directly from your wrist with the built-in Bluetooth call feature");
