...
public class PassportSeva {
    ...
    public boolean validateUser(PassportDto passportDto){
        ...
        boolean emailLoginSame = passportDto.isEmailLoginSame();
    ...
    public void getPassportDetails(){
        System.out.println("The cpvLocation is : "+this.passportDto.getCpvLocaton());
        System.out.println("The dcdrLocation is : "+this.passportDto.getDcdrLocation());
        System.out.println("The given name is : "+this.passportDto.getGivenName());
        System.out.println("The surname is : "+this.passportDto.getSurName());
        System.out.println("The dob  : "+this.passportDto.getDob());
        System.out.println("The email is : "+this.passportDto.getEmail());
        System.out.println("The email is same as login : "+this.passportDto.isEmailLoginSame());
        System.out.println("The login id : "+this.passportDto.getLoginId());
        System.out.println(" password is : "+this.passportDto.getPwd());
        System.out.println(" confirm password is : "+this.passportDto.getConfirmPwd());
        System.out.println("hint question is : "+this.passportDto.getHintQues());
        System.out.println(" hint answer is : "+this.passportDto.getHintAns());
        System.out.println(" captcha : "+this.passportDto.getCaptcha());
